...
|_> race_pred.ipynb: tập tin dùng để đưa ra kết quả dự đoán.
|_> race_training.ipynb: tập tin dùng để huấn luyện mô hình.
...
# Các đường dẫn cần sửa đổi của tập tin race_training:
...
|_> Tên biến 'skintone_model_dir': Đường dẫn đến tập tin chứa trọng số cho mô hình dự đoán skintone.

# Các đường dẫn cần sửa đổi của tập tin race_pred:
...
# Cách chạy cả 2 tập tin race_pred và race_training:
...
** Lưu ý **
    |_> Cần phải chạy tập tin race_training trước để có kết quả của mô hình để có thể chạy tập tin race_pred.
