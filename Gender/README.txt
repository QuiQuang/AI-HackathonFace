...
|_> gender_pred.ipynb: tập tin dùng để đưa ra kết quả dự đoán.
|_> gender_train.ipynb: tập tin dùng để huấn luyện mô hình.
|_> model_gender.h5: tập tin lưu trữ kết quả các trọng số của mô hình sau khi huấn luyện.
...
# Các đường dẫn cần sửa đổi của tập tin gender_train:
...
# Các đường dẫn cần sửa đổi của tập tin gender_pred:
...
# Cách chạy cả 2 tập tin gender_pred và gender_train:
...
** Lưu ý **
    |_> Cần phải chạy tập tin gender_train trước để có kết quả của mô hình (model_gender.h5) để có thể chạy tập tin gender_pred.
